...
### ➡️ 우리 팀 소개
- 정보플랫폼비즈니스TF팀(2020.8) [^1]
[^1] : 한시적인 기간 동안 특정 과업을 수행하기 위해 설립된 임시적인 조직
    - 웹/모바일 + DB(AP) => '데이터 플랫폼 구축'과 'CHECK 모바일 앱(CHECK m+)의 구현' 목표
  - 2023.2월 TF 종료 보고 후 '**정보플랫폼팀**' 될 가능성 높음
  
- 구성원:
```mermaid
  flowchart TD;
    TM[김상용 팀장]---WB1["WEB/MOBILE 파트"];
    TM---DP[Data Platform 파트];
    DP---D1[신영훈 대리];
    DP---D2[이준형 사원];
    TM---WB2["WEB/MOBILE 협력업체"];
    WB1---W1[안지원 과장];
    WB1---W2["신지선 과장\n(휴직중)"];
    WB1---W3[이상진 사원];
    WB1---W4[박민지 사원];
